...
const workerState = {
  ...
  // Re-entrancy guard for captureAndTransferFrame()
...
async function initializeGraphicsManager() {
  ...
  try {
    ...
    if (FORCE_FAST_RENDERER) {
      ...
      const graphicsManagerModule = await import("./assets/graphics_manager-Bwn1yiaQ.js");
      ...
      const graphicsManagerModule = await import("./assets/graphics_manager_threejs-DtLcIGwD.js");
